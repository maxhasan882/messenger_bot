...
func ServeWs(hub *Hub, w http.ResponseWriter, r *http.Request, roomId string, data chan MessageData) {
	...
	subscription := Subscription{Client: client, roomId: roomId, data: data}
